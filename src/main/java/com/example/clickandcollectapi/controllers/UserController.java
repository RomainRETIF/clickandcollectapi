...
public class UserController {
	...
	private @ResponseBody String update(@PathVariable("userId") Integer userId,@RequestParam String email, @RequestParam String roles, @RequestParam String password, @RequestParam boolean isVerified)   
	{  
		Optional<User> n = userRepository.findById(userId);
		if(n.isPresent()){
			User user = n.get();
